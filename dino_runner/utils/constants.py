...
HAMMER_TYPE = "hammer"
HEART_TYPE = 'heart'
#Adicionado 22/03-18h30
BUTTONS = [ 
            pygame.image.load(os.path.join(IMG_DIR, 'Buttons/button_leaderboard.png')), #0
            pygame.image.load(os.path.join(IMG_DIR, 'Buttons/button_resume.png')),# 1
            pygame.image.load(os.path.join(IMG_DIR, 'Buttons/button_quit.png')), # 2
        ]
